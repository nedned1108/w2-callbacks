...
// 2. should mimic the behavior of the built in Array.reduce
// utilizing the first element of the array as the default accumulator.

// 3. begin with the first element of the array as the accumulator
// 4. call the callback for each of the remaining elements in the array
// 5. passing in the current accumulator and current element into the callback
// 6. Upon calling the callback, the accumulator should be set to the result of the callback.
